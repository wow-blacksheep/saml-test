...
public class Saml2Settings {
    ...
    private String spAssertionConsumerServiceBinding = SamlBindingEnum.HTTP_POST.getFormat();
    private URL spSingleLogoutServiceUrl = null;
    private String spSingleLogoutServiceBinding = SamlBindingEnum.HTTP_POST.getFormat();
    private String spNameIDFormat = NameIdFormatsEnum.UN_SPECIFIED.getFormat();
    ...
    private String idpSingleSignOnServiceBinding = SamlBindingEnum.HTTP_POST.getFormat();
    private URL idpSingleLogoutServiceUrl = null;
    private URL idpSingleLogoutServiceResponseUrl = null;
    private String idpSingleLogoutServiceBinding = SamlBindingEnum.HTTP_POST.getFormat();
    ...
    private String signatureAlgorithm = SamlConstants.RSA_SHA1;
    private String digestAlgorithm = SamlConstants.SHA1;
     ...
     *
     * @param strict the strict to be set
     */
     ...
     *
     * @param debug the debug mode to be set
     */
     ...
     *
     * @param spEntityId the spEntityId value to be set
     */
     ...
     *
     * @param spAssertionConsumerServiceUrl the spAssertionConsumerServiceUrl value to be set
     */
     ...
     *
     * @param spAssertionConsumerServiceBinding the spAssertionConsumerServiceBinding value to be set
     */
     ...
     *
     * @param spSingleLogoutServiceUrl the spSingleLogoutServiceUrl value to be set
     */
     ...
     *
     * @param spSingleLogoutServiceBinding the spSingleLogoutServiceBinding value to be set
     */
     ...
     *
     * @param spNameIDFormat the spNameIDFormat value to be set
     */
     ...
     *
     * @param allowRepeatAttributeName the allowRepeatAttributeName value to be set
     */
     ...
     *
     * @param rejectDeprecatedAlg the rejectDeprecatedAlg value to be set
     */
     ...
     *
     * @param spX509certNew the spX509certNew value to be set in X509Certificate format
     */
     ...
     *
     * @param spPrivateKey the spprivateKey value to be set in PrivateKey format
     */
     ...
     *
     * @param uniqueIDPrefix the Unique ID prefix used when generating Unique ID
     */
     ...
     *
     * @param idpSingleLogoutServiceUrl the idpSingleLogoutServiceUrl value to be set
     */
     ...
     * Set the idpSingleLogoutServiceUrl setting value
     *
     * @param idpSingleLogoutServiceResponseUrl the idpSingleLogoutServiceUrl value to be set
     */
     ...
     *
     * @param authnRequestsSigned the authnRequestsSigned value to be set. Based on it the SP will sign Logout Request or not
     */
     ...
     *
     * @param logoutRequestSigned the logoutRequestSigned value to be set. Based on it the SP will sign Logout Request or not
     */
     ...
     *
     * @param logoutResponseSigned the logoutResponseSigned value to be set. Based on it the SP will sign Logout Response or not
     */
     ...
     *
     * @param wantMessagesSigned the wantMessagesSigned value to be set. Based on it the SP expects the SAML Messages to be signed or not
     */
     ...
     *
     * @param wantAssertionsSigned the wantAssertionsSigned value to be set. Based on it the SP expects the SAML Assertions to be signed or not
     */
     ...
     *
     * @param wantAssertionsEncrypted the wantAssertionsEncrypted value to be set. Based on it the SP expects the SAML Assertions to be encrypted or not
     */
     ...
     *
     * @param wantNameIdEncrypted the wantNameIdEncrypted value to be set. Based on it the SP expects the NameID to be encrypted or not
     */
     ...
     *
     * @param signMetadata the signMetadata value to be set. Based on it the SP will sign or not the metadata with the SP PrivateKey/Certificate
     */
     ...
     *
     * @param wantXMLValidation the wantXMLValidation value to be set. Based on it the SP will validate SAML messages against the XML scheme
     */
     ...
     *
     * @param digestAlgorithm the digestAlgorithm value to be set.
     */
     ...
     *
     * @param compressResponse the compressResponse value to be set.
     */
     ...
     *
     * @param trimNameIds set to <code>true</code> to trim parsed Name IDs, set to
     ...
     *
     * @param trimAttributeValues set to <code>true</code> to trim parsed attribute values, set to
     *                            <code>false</code> to keep them intact
     */
    ...
    public List<String> checkSPSettings() {
        ...
        if (this.getHsm() == null && (this.getAuthnRequestsSigned() || this.getLogoutRequestSigned() || this.getLogoutResponseSigned() || this.getWantAssertionsEncrypted() || this.getWantNameIdEncrypted()) && !this.checkSPCerts()) {
        ...
        if (!contacts.isEmpty()) {
            ...
            validTypes.add(SamlConstants.CONTACT_TYPE_TECHNICAL);
            validTypes.add(SamlConstants.CONTACT_TYPE_SUPPORT);
            validTypes.add(SamlConstants.CONTACT_TYPE_ADMINISTRATIVE);
            validTypes.add(SamlConstants.CONTACT_TYPE_BILLING);
            validTypes.add(SamlConstants.CONTACT_TYPE_OTHER);
     ...
     *
     * @param value the current value of the property to be checked
     * @return true if the SP settings are valid
     */
     ...
     *
     * @param spValidationOnly the spValidationOnly value to be set
     */
    ...
    public String getSPMetadata() throws CertificateEncodingException {
        ...
        if (signMetadata) {
            try {
                ...
                log.debug("Saml Error executing signMetadata: " + e.getMessage(), e);
            }
        }
    ...
    public static List<String> validateMetadata(String metadataString) throws Exception {
        ...
        if (!SamlXmlUtils.validateXML(metadataDocument, SchemaFactory.SAML_SCHEMA_METADATA_2_0)) {
            ...
            if (!rootElement.getLocalName().equals("EntityDescriptor")) {
                ...
                if (rootElement.getElementsByTagNameNS(SamlConstants.NS_MD, "SPSSODescriptor").getLength() != 1) {
