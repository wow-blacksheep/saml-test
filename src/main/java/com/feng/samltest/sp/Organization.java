...
public class Organization {
     ...
     * @param orgDisplayName   String. Organization display name
     * @param orgUrl           URL. Organization URL
     * @param orgLangAttribute The xml lang attribute, describing name and display name
     */
     ...
     * @param orgName          String. Organization name
     * @param orgDisplayName   String. Organization display name
     * @param orgUrl           String. Organization URL
     * @param orgLangAttribute The xml lang attribute, describing name and display name
     */
