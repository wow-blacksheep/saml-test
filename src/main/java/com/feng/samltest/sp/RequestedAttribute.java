...
public class RequestedAttribute {
     ...
     * Constructor
     *
     * @param name            String. RequestedAttribute Name
     * @param friendlyName    String. RequestedAttribute FriendlyName
     * @param isRequired      Boolean. RequestedAttribute isRequired value
     * @param nameFormat      Boolean. RequestedAttribute NameFormat
     * @param attributeValues List. RequestedAttribute values
     */
